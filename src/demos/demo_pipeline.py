...
#%% Select file(s) to be processed (download if not present)
    ...
    fnames = "/media/remy/remy-storage/Remy's Dropbox Folder/" \
             "HongLab @ Caltech Dropbox/Remy/mb_odor_rearing/" \
             "data/processed_data/2021-06-26/1/movie_002/Image_001_001.tif"

#%% First setup some parameters for data and motion correction

    # dataset dependent parameters
    fr = 5.1             # imaging rate in frames per second
    decay_time = 10    # length of a typical transient in seconds
    dxy = (0.2, 0.2)      # spatial resolution in x and y in (um per pixel)
    # note the lower than usual spatial resolution here
    max_shift_um = (5., 5.)       # maximum shift in um
    patch_motion_um = (2**6, 2**6)  # patch size for non-rigid correction in um
...
# %% MEMORY MAPPING
    ...
    # now load the file
    fname_new = "/media/remy/remy-storage/Remy's Dropbox Folder/HongLab @ Caltech Dropbox/Remy/mb_odor_rearing/data/processed_data/2021-06-26/1/movie_002/memmap__d1_512_d2_512_d3_1_order_C_frames_3864_.mmap"
